...
- [07 Advanced Language Features](docs/07-advanced-language-features/01-pattern-combinators.md)
  ...
  - [11 Nullable Value Types](docs/07-advanced-language-features/11-nullable-value-types.md)
  - [12 Caller Information Attributes](docs/07-advanced-language-features/12-caller-information-attributes.md)
  - [11 Nullable Value Types](docs/07-advanced-language-features/11-nullable-value-types.md)
  - [12 Caller Information Attributes](docs/07-advanced-language-features/12-caller-information-attributes.md)
...
- [09 LINQ and Data Queries](docs/09-linq-and-data-queries/01-linq-overview.md)
  ...
  - [05 LINQ Operators Overview](docs/09-linq-and-data-queries/05-linq-operators-overview.md)
  - [06 LINQ to XML](docs/09-linq-and-data-queries/06-linq-to-xml.md)
  - [05 LINQ Operators Overview](docs/09-linq-and-data-queries/05-linq-operators-overview.md)
  - [06 LINQ to XML](docs/09-linq-and-data-queries/06-linq-to-xml.md)
...
- [11 C# How-To Guides](docs/11-csharp-how-to-guides/01-strings-and-text-processing.md)
  ...
  - [06 Dates, Times, and Formatting](docs/11-csharp-how-to-guides/06-dates-times-and-formatting.md)
  - [06 Dates, Times, and Formatting](docs/11-csharp-how-to-guides/06-dates-times-and-formatting.md)
...
- [14 .NET Platform and Runtime](docs/14-dotnet-platform-and-runtime/01-dotnet-platform-overview.md)
  ...
  - [17 Networking, URIs, and HttpClient](docs/14-dotnet-platform-and-runtime/17-networking-uris-and-httpclient.md)
  - [18 Assemblies, Reflection, and Metadata](docs/14-dotnet-platform-and-runtime/18-assemblies-reflection-and-metadata.md)
  - [19 Regular Expressions](docs/14-dotnet-platform-and-runtime/19-regular-expressions.md)
