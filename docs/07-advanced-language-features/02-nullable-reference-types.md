...
Nullable reference types turn many null-related mistakes into compile-time warnings. They encourage you to express absence explicitly instead of relying on convention or hope.
