...
User-defined conversions let a type participate in conversion syntax. They should communicate meaning clearly instead of hiding surprising transformations.
