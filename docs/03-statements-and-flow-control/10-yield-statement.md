...
The `yield` statement makes lazy iteration easier to express. Instead of collecting everything first, an iterator can describe how values are produced over time.
